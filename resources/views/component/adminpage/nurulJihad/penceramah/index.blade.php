                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Daftar Penceramah</div>
                            <div class="pt-2"><a class="btn btn-primary"
                                    href="{{ route('create-penceramah-nuruljihad-admin') }}">Tambah
                                    Data</a>
                            </div>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-buttom-action">
                                                        ...
                                                        <form
                                                            action="{{ route('delete-penceramah-nuruljihad-admin', $item->id) }}"
