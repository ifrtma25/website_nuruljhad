        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('daftar_santri-rumah_tahfidz-admin') }}">Daftar Santri</a>
                    </li>
                    <li class="separator">
                        <i class="fas fa-chevron-right"></i>
                    </li>
            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <div class="card">
                        ...
                        <form action="{{ route('update-daftar_santri-rumah_tahfidz-admin', $daftarsantri->id) }}"
                                    ...
                                    <div class="col-md-6 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama" name="nama"
                                                value="{{ $daftarsantri->nama }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="alamat">Alamat</label>
                                            <input type="text" class="form-control" id="alamat" name="alamat"
                                                value="{{ $daftarsantri->alamat }}">
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="card-action">
                                ...
                                <a href="{{ route('daftar_santri-rumah_tahfidz-admin') }}" class="btn btn-danger">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
