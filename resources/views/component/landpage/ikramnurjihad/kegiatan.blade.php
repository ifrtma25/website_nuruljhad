...
@section('title', 'IkramnurJihad - Kegiatan')
@section('content')
    @include('includes.landPage.header.ikramnurjihad')
                ...
                @foreach ($kegiatan as $item)
                    <div class="col-md-4">
                        <div class="cause shadow-sm">
                            ...
                            <a href="{{ asset('storage/' . $item->gambar) }}" class="cause-link d-block" target="bankspace">
