...
@section('content')
    <div class="owl-carousel-wrapper">
        ...
        <div class="box-92819">
            <h1 class="text-white mb-3">Yayasan Pesantren Darul Istiqamah Cabang Manggarupi</h1>
            {{-- <p><a href="#" class="btn btn-primary py-3 px-4 rounded-0">Donate Now</a></p> --}}
        </div>

        <div class="owl-carousel owl-1 ">
            <div class="ftco-cover-1 overlay" style="background-image: url('assets/landpage/images/image_1.jpg');">
            </div>
            <div class="ftco-cover-1 overlay" style="background-image: url('assets/landpage/images/image_2.jpg');">
            </div>
            <div class="ftco-cover-1 overlay" style="background-image: url('assets/landpage/images/image_3.jpg');">
            </div>
            <div class="ftco-cover-1 overlay" style="background-image: url('assets/landpage/images/image_4.jpg');">
            </div>
            <div class="ftco-cover-1 overlay" style="background-image: url('assets/landpage/images/image_5.jpg');">
            </div>
    ...
    <div class="container">
        <div class="feature-29192-wrap d-md-flex" style="margin-top: -20px; position: relative; z-index: 2;">
            ...
            <a href="#" class="feature-29192 overlay-warning"
                style="background-image: url('assets/landpage/images/image_1.jpg');">
                <div class="text">
                    {{-- <span class="meta">Masjid</span> --}}
                    <h3 class="text-cursive text-white h1">Masjid Nurul Jihad Manggarupi</h3>
                </div>
            </a>
                        ...
                        <a href="#" class="cause-link d-block">
                            ...
                            <div class="custom-progress-wrap">
                                ...
                                <div class="custom-progress-inner">
                                    <div class="custom-progress bg-pimary" style="width: 80%;"></div>
                                </div>
                            </div>
                        </a>
                        ...
                        <div class="col-md-6 mb-5">
                            <div class="feature-29012 d-flex">
                                ...
                                <div>
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi id sint
                                        explicabo odit reiciendis
